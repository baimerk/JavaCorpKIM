...
public class WarriorAir extends AirMachine {
    ...
    public void DescriptionAll() {
        System.out.printf("Info: \n" +
                ...
                "Количество ракет: %d, \nБизнес-класс %s,", this.CountPower(), this.getMaxSpeed(), this.getTotalMass(), this.getBrand(), this.getWingspan(), this.getStringLength(), this.RocketSc, this.SystemBreaks);
    }
    ...
    private void ShootCounter() {
        int Shoot;
        for (int i = 1; i < RocketSc; i++) {
            Scanner g = new Scanner(System.in);
            System.out.println("Ракета пошла!\n");
            System.out.println("Выпущено: " + i + "rocket\n");
